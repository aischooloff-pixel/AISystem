...
class Dialog(StatesGroup):
    ...
    # b_duration — вопрос о давности ситуации, добавлен по просьбе Юлии
    # 2026-07-28: повторяемость — один из девяти признаков, которые AI
    # обязан оценить («Логика принятия решений», раздел 7), а понять её
    # без срока нельзя.
    b_duration = State()
    b_question_2 = State()
    b_question_3 = State()
